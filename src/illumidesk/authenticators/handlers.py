...
class LTI13LoginHandler(OAuthLoginHandler, OAuth2Mixin):
    ...
    def post(self):
        ...
        URL using the redirect_uri which in turn uses the guess_callback_uri
    ...
    def set_state_cookie(self, state):
        ...
        self.set_secure_cookie(STATE_COOKIE_NAME, state, expires_days=1, httponly=True, secure=True)


class LTI13CallbackHandler(OAuthCallbackHandler):
    """
    LTI v1.3 call back handler
    """
