...
# test_authenticator_returns_username_in_auth_state_with_valid_course_id
# test_authenticator_returns_username_in_auth_state_with_valid_lms_user_id
# test_authenticator_returns_username_in_auth_state_with_valid_user_role
# test_authenticator_uses_lti13validator
