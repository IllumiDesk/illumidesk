...
@pytest.mark.asyncio
async def test_authenticator_invokes_lti13validator_handler_get_argument(build_lti13_jwt_id_token, make_lti13_resource_link_request):
    """
...
@pytest.mark.asyncio
async def test_authenticator_invokes_lti13validator_validate_launch_request(make_lti13_resource_link_request, build_lti13_jwt_id_token):
    """
...
async def test_authenticator_returns_course_id_in_auth_state_with_valid_resource_link_request(
    auth_state_dict, make_lti13_resource_link_request, build_lti13_jwt_id_token
):
    """
...
@pytest.mark.asyncio
async def test_authenticator_returns_auth_state_name_from_lti13_email_claim(make_lti13_resource_link_request, build_lti13_jwt_id_token):
    """
...
@pytest.mark.asyncio
async def test_authenticator_returns_workspace_type_in_auth_state(make_lti13_resource_link_request, build_lti13_jwt_id_token):
    """
...
@pytest.mark.asyncio
async def test_authenticator_returns_learner_role_in_auth_state(make_lti13_resource_link_request, build_lti13_jwt_id_token):
    """
