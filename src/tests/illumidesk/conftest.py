...
def make_lti13_resource_link_request() -> Dict[str, str]:
    def _make_lti13_resource_link_request() -> Dict[str, str]:
        """
...
@pytest.fixture(scope='function')
def lti13_id_token_complete(make_lti13_resource_link_request) -> str:
    import jwt
    json_lti13_launch_request = make_lti13_resource_link_request()
    jwt = jwt.encode(json_lti13_launch_request, 'secret', algorithm='HS256')
    return jwt
    # return 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImtpZCI6IjIwMjAtMDQtMDFUMDA6MDA6MDRaIn0..mtOYCPFyYcO6dbze4W_yd8hflSzsXhG6NnHhe9lVsdE'
