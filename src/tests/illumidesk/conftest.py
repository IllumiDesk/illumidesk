...
def make_lti11_success_authentication_request_args():
    def _make_lti11_success_authentication_request_args(
        ...
        args = {
            ...
            'custom_canvas_assignment_title': ['test-assignment-canvas-title'.encode()],
            'custom_assignment_title': ['test-assignment-title'.encode()],
            ...
            'resource_link_title': ['test-assignment'.encode()],
            'roles': [role.encode()],
